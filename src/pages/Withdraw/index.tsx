    ...
    const onSubmit = (data: any) => {
        ...
        switch (data.payoutType) {
            case 'bitcoin':
                ...
                gTag('withdraw_create', { method: 'BTC', amount: data.amount.substring(1) });
                setLoading('');
                break;
            case 'paypal':
                alert('withdraw with paypal');
                setLoading('');
                break;
            case 'mastercard':
                alert('withdraw with mastercard');
                setLoading('');
                break;
            case 'visa':
                alert('withdraw with visa');
                setLoading('');
                break;
            case 'stripe':
